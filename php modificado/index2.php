...
<?php
  ...
  $api_endpoint = "http://ip172-18-0-26-chn8gig9ec4g00fdlo7g-5000.direct.labs.play-with-docker.com/api/";//reemplaze el dominio, por ejemplo http://localhost quedando algo como $api_endpoint = "http://localhost/api/";
  $url = "";
